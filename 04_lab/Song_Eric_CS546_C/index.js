...
const main = async () => {
  ...
  //13
  try {
    await bands.rename("507f1f77bcf86cd799439012", "error");
  } catch (e) {
    console.log(e.message);
  }
  //14
  try {
    await bands.rename(pinkFloyd["_id"].toString(), "Floyd Pink");
  } catch (e) {
    console.log(e.message);
  }
  //15
  let caseFifteen = undefined;
  try {
    caseFifteen = await bands.get("507f1f77bcf86cd799439012");
  } catch (e) {
    console.log(e.message);
  }
